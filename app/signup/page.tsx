...
export const metadata = {
  title: "회원가입 | HAT-TRICK",
  description: "Join the squad. HAT-TRICK 회원가입 페이지입니다.",
};

export default function SignupPage() {
  return (
    <div
      className="min-h-screen relative flex flex-col items-center justify-center overflow-x-hidden overflow-y-auto py-[100px] px-4"
      style={{
        backgroundImage:
